...
import marketData from '../data/market-conversations.json'
import './LessonPage.css'

const MarketConversations = () => {
  const { user } = useAuth()
  ...
  const handleTestComplete = async (result) => {
    ...
    if (user) {
      ...
      await saveProgress(user.id, 'market-conversations', result.score, completed)
    }
  }
  ...
  return (
    <div className="lesson-page">
      <header className="lesson-header">
        ...
        <p>Buying, bargaining, and talking at the market</p>
      ...
      {!showTest ? (
        <>
          ...
          <div className="lessons-section">
            <h2>🛒 Market & Shopping Phrases</h2>
            <p className="section-description">Asking price, bargaining, and buying at the market</p>
            <div className="lessons-grid">
              {marketData.lessons.map((item) => (
        ...
        <MCQTest mcqs={marketData.mcqs} onComplete={handleTestComplete} />
      ) : (
...
export default MarketConversations
