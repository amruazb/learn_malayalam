...
const Day9 = () => {
  ...
  useEffect(() => {
    const checkUnlocked = async () => {
      if (user) {
        ...
        const day5Completed = progress.some(p => p.lesson_id === 'day-8' && p.completed)
  ...
  const handleTestComplete = async (result) => {
    ...
    if (user) {
      ...
      await saveProgress(user.id, 'day-9', result.score, completed)
    }
  }
  ...
  return (
    <div className="lesson-page">
      <header className="lesson-header">
        <h1>📅 Day {day9Data.day}: {day9Data.title}</h1>
        <p>{day9Data.description}</p>
      </header>
      ...
      {!showTest ? (
        <>
          ...
          {day9Data.sections.map((section, index) => (
          ...
          <div className="navigation-section">
            <Link to="/day/8" className="prev-lesson-btn">
              ← Day 5
            </Link>
        ...
        <MCQTest mcqs={day9Data.mcqs} onComplete={handleTestComplete} />
      ) : (
        <div className="result-card">
          ...
          {testResult.percentage >= 60 ? (
            <div className="result-message success">
              <p>🎉 Congratulations! You've completed Day 9!</p>
          ...
          <div className="result-actions">
            ...
            {testResult.percentage >= 60 && (
              <Link to="/day/10" className="next-lesson-btn">
                Continue to Day 7 →
              </Link>
            )}
